...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class AsyncMethodToStateMachineRewriter : MethodToStateMachineRewriter
    {
            ...
            : base(F, method, state, hoistedVariables, nonReusableLocalProxies, synthesizedLocalOrdinals, slotAllocatorOpt, nextFreeHoistedLocalSlot, diagnostics, useFinalizerBookkeeping: false)
        {
            ...
            _exprRetValue = method.IsGenericTaskReturningAsync(F.Compilation) || method.IsGenericFutureReturningAsync(F.Compilation)
            ...
            bodyBuilder.Add(
                F.ExpressionStatement(
                    F.Call(
                        ...
                        _method.IsGenericTaskReturningAsync(F.Compilation) || _method.IsGenericFutureReturningAsync(F.Compilation)
        ...
        public override BoundNode VisitReturnStatement(BoundReturnStatement node)
        {
            ...
            {
                Debug.Assert(_method.IsGenericTaskReturningAsync(F.Compilation) || _method.IsGenericFutureReturningAsync(F.Compilation));
                return F.Block(
